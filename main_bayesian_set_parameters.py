...
from src.train_utils import (
    ...
    train_pyro_model_with_val  # Bayesian
)
...
def main():
    ...
    # ---------------------------------------------------------
    # Feel free to change these values manually or set them via command-line args
    hidden_size   = 16      # e.g. 16, 32, etc.
    num_layers    = 2       # e.g. 1, 2, 3 ...
    learning_rate = 0.001   # e.g. 0.001, 0.0005, etc.
    ...
    # ---------------------------------------------------------
    log_message("Performing 5-fold CV with user-defined hyperparams...")
    ...
    # Save user-defined hyperparams to its own file
